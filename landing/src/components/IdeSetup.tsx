...
export default function IdeSetup() {
  ...
  return (
    ...
    >
      {/* Diagonal line square decoration — right side */}
      <div
          ...
          {ides.map((i) => (
            <button
              ...
              style={{
                ...
                background: activeIde === i.id ? "rgba(0,0,0,0.04)" : "none",
                backdropFilter: activeIde === i.id ? "blur(8px)" : "none",
                WebkitBackdropFilter: activeIde === i.id ? "blur(8px)" : "none",
                border: "none",
                borderRadius: 8,
                cursor: "pointer",
          ...
          {runners.map((r) => (
            <button
              ...
              style={{
                ...
                background: activeRunner === r.id ? "rgba(0,0,0,0.04)" : "none",
                backdropFilter: activeRunner === r.id ? "blur(8px)" : "none",

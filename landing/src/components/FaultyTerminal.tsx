...
void main() {
    ...
    // Invert: light background, dark glyphs
    col = vec3(1.0) - col;

    // Diagonal opacity gradient: smooth ramp from mid-screen to bottom-right
    float rawGradient = (uv.x + (1.0 - uv.y)) * 0.5;
    float gradientOpacity = smoothstep(0.3, 1.0, rawGradient);
    col = mix(uTint, col * uTint, gradientOpacity);
    col *= uBrightness;
